...
void FunctionAdd(string[] args)
{
    try
    {
        if (args.Length == 1)
        {
            ...
            else Console.WriteLine("No words added.");
        }
        else Console.WriteLine("Usage:\n-add <listname>");
...
void FunctionWords(string[] args)
{
    try
    {
        if (args.Length == 1 || args.Length == 2)
        {
            ...
            else Console.WriteLine($"No words in list {name}");
        }
...
void FunctionCount(string[] args)
{
    try
    {
        if (args.Length == 1)
        {
            ...
            if(wordList.Count > 0) Console.WriteLine($"{wordList.Count} {(wordList.Count > 1 ? "words" : "word")} in the list {name}.");                
            else Console.WriteLine($"No words in list {name}.");
        }
        else Console.WriteLine("Usage:\n-count <listname>");
